...
<template>
  <Transition name="slide-up">
    <div v-if="isRevealed && votingResults" class="stats-panel">
      <!-- Header -->
      ...
      <div>
        ...
        <div class="space-y-3">
          ...
          >
            <!-- Card value -->
            <div
              class="w-12 h-12 flex-shrink-0 rounded-lg bg-poker-card flex items-center justify-center"
            >
      ...
      <!-- Votes info -->
      <div
        class="mt-6 pt-6 border-t border-white/10 flex justify-between text-sm text-white/50"
      >
