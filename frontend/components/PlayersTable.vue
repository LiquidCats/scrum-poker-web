  ...
  <div class="w-full">
    ...
    <div 
      ...
      :class="[
        ...
        players.length <= 6 ? 'grid-cols-3 md:grid-cols-6' :
    ...
    <Transition name="bounce">
      <div 
        v-if="allPlayersVoted && !isRevealed"
        class="mt-8 text-center"
      >
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-poker-gold/20 border border-poker-gold/30 animate-pulse-glow">
          <svg class="w-5 h-5 text-poker-gold" fill="currentColor" viewBox="0 0 20 20">
