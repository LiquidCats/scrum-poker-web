  ...
  <div class="w-full">
    ...
    <Transition name="slide-up">
      ...
      >
        ...
        <div class="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-poker-gold/10 border border-poker-gold/30">
          <span class="text-3xl font-bold text-poker-gold">{{ selectedValue }}</span>
        </div>
      </div>
    </Transition>
  </div>
