    ...
    <div class="relative">
      <div
        ...
        :class="[
          ...
          avatarColor,
          {
            'ring-2 ring-poker-gold ring-offset-2 ring-offset-poker-felt shadow-glow':
              player.hasVoted,
          },
        ]"
      >
      ...
      >
        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          <path
            d="M10 2l2.5 5 5.5.5-4 4 1 5.5L10 14l-5 3 1-5.5-4-4 5.5-.5L10 2z"
          />
        </svg>
      </div>
