...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"Real-time Scrum Poker for agile teams"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Scrum Poker"};
